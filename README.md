...
5. Elaborar un programa en java que permita calcular el interés del 25.5 % de un préstamo de  y calcular el igv del 18% del interés calculado.
6. Elaborar un programa que permite resolver si un numero es primo 
